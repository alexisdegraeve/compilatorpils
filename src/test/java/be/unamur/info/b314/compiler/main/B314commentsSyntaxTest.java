...
public class B314commentsSyntaxTest {
    ...
    //
    @Test
    public void test_programme_minimal() throws Exception{
        CompilerTestHelper.launchCompilation("/syntax/comments/ok/programme_minimal.b314", testFolder.newFile(), true, "variables: comments_everywhere");
    }

    @Test
    public void test_import_file() throws Exception{
        CompilerTestHelper.launchCompilation("/syntax/comments/ok/test_filedecl.b314", testFolder.newFile(), true, "variables: comments_everywhere");
    }

    @Test
    public void test_declare_and_retain() throws Exception{
        CompilerTestHelper.launchCompilation("/syntax/comments/ok/test_declare_and_retain.b314", testFolder.newFile(), true, "variables: comments_everywhere");
    }
    ...
    @Test
    public void test_double_slash_ok() throws Exception{
        CompilerTestHelper.launchCompilation("/syntax/comments/ok/comments_double_slash.b314", testFolder.newFile(), true, "variables: comments_everywhere");
    }
    ...
    //
    @Test
    public void test_double_slash_ko() throws Exception{
        CompilerTestHelper.launchCompilation("/syntax/comments/ok/missing_double_slash.b314", testFolder.newFile(), true, "variables: comments_everywhere");
    }
